...
import top.soaringlab.test.weather.processor.TempTrendIntervalAndDiffProcessor;
...
public class main_direct {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<ColdWaveInterval> temTrendIntervalEvent = temForTrend.assignTimestampsAndWatermarks(new BoundedOutOfOrdernessTimestampExtractor<TemperatureEvent>(Time.minutes(1)) {
                    @Override
                ...
                .process(new TempTrendIntervalAndDiffProcessor());
