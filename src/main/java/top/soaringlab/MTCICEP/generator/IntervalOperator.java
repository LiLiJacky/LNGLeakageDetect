...
//                                String k = String.valueOf(value.getKey());
//                                return k;
//                            }
//                        })
...
//                        ) {
//                            Match match = new Match(first, second, Match.MatchType.Before, first.getKey());
////                            System.out.println(first.getKey() + "" + second.getKey());
//                            return match;
//                        } else {
//                            return new Match();
//                        }
...
//                    public Match join(X first, X second) throws Exception {
//                        if ((first.getStartTimestamp() < second.getStartTimestamp()) && (first.getEndTimestamp() == second.getStartTimestamp())) {
//                             Match match = new Match(first, second, Match.MatchType.Meets, first.getKey());
//                            return match;
//                        } else {
//                            return new Match();
//                        }
...
//                             Match match = new Match(first, second, Match.MatchType.Equals, first.getKey());
//                            return match;
//                        } else {
//                            return new Match();
//                        }
...
//                             Match match = new Match(first, second, Match.MatchType.Overlaps, first.getKey());
//                            return match;
//                        } else {
//                            return new Match();
//                        }
...
//                    public Match join(X first, X second) throws Exception {
//                        if ((first.getStartTimestamp() > second.getStartTimestamp()) && (first.getEndTimestamp() < second.getEndTimestamp())) {
//                             Match match = new Match(first, second, Match.MatchType.During, first.getKey());
//
//                            return match;
//                        } else {
//                            return new Match();
...
//                    public Match join(X first, X second) throws Exception {
//                        if ((first.getStartTimestamp() == second.getStartTimestamp()) && (first.getEndTimestamp() < second.getEndTimestamp())) {
//                             Match match = new Match(first, second, Match.MatchType.Starts, first.getKey());
//
//                            return match;
//                        } else {
//                            return new Match();
...
//                    public Match join(X first, X second) throws Exception {
//                        if ((first.getStartTimestamp() > second.getStartTimestamp()) && (first.getEndTimestamp() == second.getEndTimestamp())) {
//                             Match match = new Match(first, second, Match.MatchType.Finishes, first.getKey());
//
//                            return match;
//                        } else {
//                            return new Match();
...
//                    public Match join(X first, X second) throws Exception {
//                        if ((first.getStartTimestamp() < second.getStartTimestamp()) && (first.getEndTimestamp() > second.getEndTimestamp())) {
//                             Match match = new Match(first, second, Match.MatchType.Contains, first.getKey());
//
//                            return match;
//                        } else {
//                            return new Match();
...
//                    public Match join(X first, X second) throws Exception {
//                        if ((first.getStartTimestamp() == second.getStartTimestamp()) && (first.getEndTimestamp() > second.getEndTimestamp())) {
//                             Match match = new Match(first, second, Match.MatchType.StartedBy, first.getKey());
//
//                            return match;
//                        } else {
//                            return new Match();
...
//                             Match match = new Match(first, second, Match.MatchType.MetBy, first.getKey());
//
//                            return match;
//                        } else {
//                            return new Match();
...
//                             Match match = new Match(first, second, Match.MatchType.After, first.getKey());
//
//                            return match;
//                        } else {
//                            return new Match();
